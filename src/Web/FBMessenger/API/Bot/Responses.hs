...
import           GHC.Generics
import           Servant.Client                  (ServantError (..), GenResponse(..))
...
newtype MessengerProfileResponse = MessengerProfileResponse { mpResult :: Text } deriving (Eq, Show)

instance FromJSON MessengerProfileResponse where
    parseJSON = withObject "response" $ \o ->
        MessengerProfileResponse <$> o .: "result"
...
extractSendError (FailureResponse res) = decode (responseBody res) :: Maybe SendErrorObject
